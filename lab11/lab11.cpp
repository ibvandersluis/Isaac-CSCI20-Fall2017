Pick a number between 1 and 50 (inclusive)
Prompt user to guess the number
if guess is correct, the user wins! Their score is 10 points, minus one point for each incorrect guess
if guess is higher than number, say "Guess Lower" and return to step 2
